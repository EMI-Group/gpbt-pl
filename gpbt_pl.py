...
@PublicAPI
class GeneralizedPBT_PairwiseLearning(FIFOScheduler):
    ...
    def on_trial_add(self, trial_runner: "trial_runner.TrialRunner", trial: Trial):
        ...
        self._trial_state[trial] = _GPBT_PLTrialState(trial)
    ...
    def _save_trial_state(
        self, state: _GPBT_PLTrialState, time: int, result: Dict, trial: Trial
    ):
    ...
    def _log_config_on_step(
        self,
        trial_state: _GPBT_PLTrialState,
        new_state: _GPBT_PLTrialState,
        trial: Trial,
    ...
    def _get_new_config(self, trial: Trial, trial_to_clone: Trial, trial_runner: "trial_runner.TrialRunner") -> Tuple[Dict, Dict]:
    ...
    def _exploit(
        ...
        new_config, operations = self._get_new_config(trial, trial_to_clone, trial_runner)
